...
const Experience = () => {
  const experiences: ExperienceItem[] = [
    {
      ...
      company: "Innoscript Technologies",
      period: "June 2024 - August 2024",
      description: [
        "Build responsive, scalable web applications using React, Node.js, and MongoDB",
  ...
  const education: EducationItem[] = [
    ...
    },
    {
      ...
      institution: "Punjab Group of College, Gujranwala",
