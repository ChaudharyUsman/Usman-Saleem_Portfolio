...
With deep expertise in the NEXT.js, and Generative AI, I specialize in building full-stack applications, AI-powered systems, and automation workflows that solve real-world problems for businesses.
            ...
            <div className={styles.buttons}>
              ...
              <Link href="/Usman Saleem Full_Stack.pdf" className={styles.secondaryBtn} download>
                <Download size={16} />
                Download Resume
              </Link>
            </div>
