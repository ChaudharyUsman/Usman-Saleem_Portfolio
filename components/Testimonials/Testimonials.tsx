  ...
  const testimonials: Testimonial[] = [
    {
      ...
      text: "Working with Usman was an absolute pleasure. His technical expertise and problem-solving skills are exceptional. He delivered our project ahead of schedule and exceeded our expectations in every way.",
      rating: 5,
    },
    {
      id: 2,
      ...
      text: "Usman's work on our AI agent was outstanding. He has a deep understanding of AI technologies and implemented solutions that significantly improved our customer support and lead collection processing efficiency.",
      rating: 5,
    },
    {
      id: 3,
      ...
      text: "I've worked with many developers, but Usman stands out for his attention to detail and commitment to quality. He's not just a coder but a true problem solver who understands business needs.",
      rating: 5,
    },
    {
      id: 4,
      ...
      text: "Usman helped us build our MVP in record time. His full-stack skills and ability to quickly understand our vision were invaluable. I highly recommend him for any challenging project.",
      rating: 5,
    },
  ]
